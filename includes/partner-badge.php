 ...
 */
$ppSlug = isset($partnerProfileSlug) && $partnerProfileSlug !== '' ? (string) $partnerProfileSlug : 'express-pro-cleaning-services-sacramento-ca';
$ppName = isset($partnerProfileName) && $partnerProfileName !== '' ? (string) $partnerProfileName : 'Express Pro Cleaning Services';
...
<div class="poi-partner-seal" style="text-align:center;padding:4px 16px 24px">
  <a href="https://pageonepartner.com/<?php echo $ppSlug; ?>/" target="_blank" rel="nofollow noopener" title="<?php echo $ppNameEsc; ?> on Page One Partner" style="display:inline-block;line-height:0;border-radius:14px">
    <img src="/assets/images/partner-badge.svg" alt="<?php echo $ppNameEsc; ?> — Verified Local Partner on Page One Partner" width="240" height="67" loading="lazy" decoding="async" style="border:0;max-width:100%;height:auto">
  </a>
</div>
<?php endif; ?>
